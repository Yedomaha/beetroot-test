		...
		<div class="wpo-fieldgroup">
			<fieldset>
				...
				<label for="inline_css">
					...
					<span tabindex="0" data-tooltip="<?php _e('When enabled, the CSS files generated by WP-Optmize will be inlined.', 'wp-optimize');?>"><span class="dashicons dashicons-editor-help"></span> </span>
				</label>
